<template>
    <button type="button" @click="toggle"
     ...
     <aside :class="{ 'translate-x-0': is_expanded, '-translate-x-full': !is_expanded }" 
        id="sidebar"
        class=" fixed top-0 left-0 z-40 w-64 le transition-transform duration-300 ease-in-out transform bg-white dark:bg-gray-800  "
        aria-label="Sidebar">
        <div class="h-full overflow-y-auto bg-gray-200 ">
            <div class="bg-white py-10 px-4 rounded-b shadow-md">
                <ul class=space-y-2>
                    <li class="text-start">
                        <div class="flex flex-row items-center h-8">
                            <img class="w-auto h-6" src="https://img.icons8.com/color/48/000000/vue-js.png" />
                            <div class="flex flex-col">
                                <span class="ms-4 text-sm font-semibold text-gray-500">Nume User</span>
            ...
            <div class="bg-white py-10 px-4 rounded-t shadow-md mt-2  overflow-hidden`">
